...
class ContextDisambiguator:
    ...
    def _estimate_valence(self, message: str) -> float:
        ...
        pos_count = sum(1 for word in positive_words if f"\\b{word}\\b" in msg_lower or word in msg_lower)
        neg_count = sum(1 for word in negative_words if f"\\b{word}\\b" in msg_lower or word in msg_lower)
